...
@section('title' , 'Index All Article')

@section('main_title' , 'Index All Article')
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <td>{{ $article->title }}</td>
                    <td><a class="btn btn-info" href="{{ route('indexCategoryArticles',$article->category_id) }}">{{ $article->category->name }}</a></td>
