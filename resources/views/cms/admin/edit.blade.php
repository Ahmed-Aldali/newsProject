            ...
            <form>
              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  value="{{ $admins->user->last_name }}" placeholder="Enter Name of Admin">
                </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    value="{{ $admins->user->address }}" placeholder="Enter Name of Admin">
                  </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    value="{{ $admins->user->date }}" placeholder="Enter Name of Admin">
                  </div>
                  <div class="form-group col-md-6">
